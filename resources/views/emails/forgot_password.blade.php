...
<head>
    ...
    <title>Reset Your Password - Formation Négociation Banque</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 30px 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #4a5568;">
                                We received a request to reset the password associated with your account on <strong>Formation Négociation Banque</strong>. You can reset your password by clicking the button below:
                            </p>
                            ...
                            <!-- Expiration warning -->
                            <div style="background-color: #fffaf0; border-left: 4px solid #dd6b20; padding: 15px; margin: 20px 0; border-radius: 0 6px 6px 0; font-size: 14px; color: #7b341e;">
                                <strong>Please note:</strong> This password reset link is valid for a limited time and will expire shortly.
                            </div>
                            ...
                            <p style="margin: 30px 0 0 0; font-size: 14px; line-height: 1.6; color: #718096; border-top: 1px solid #edf2f7; padding-top: 20px;">
                                If you did not request a password reset, no further action is required. Your account password remains secure.
                            </p>
                        </td>
                    </tr>
