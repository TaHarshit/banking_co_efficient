                            ...
                            <form class="row g-3 needs-validation" action="{{ route('updateprofile') }}" method="POST"
                                ...
                                {{-- <div class="col-12 position-relative">
                                    ...
                                    <div class="{{ $errors->has('profile_image') ? 'is-invalid' : '' }}">
                                        <input type="file" name="profile_image" class="dropify" id="profile_image" data-default-file="{{isset($data) && Storage::exists('public/profile_image/'.$data->profile_image) ? asset('storage/profile_image/'.$data->profile_image) : ''}}">
                                    </div>
